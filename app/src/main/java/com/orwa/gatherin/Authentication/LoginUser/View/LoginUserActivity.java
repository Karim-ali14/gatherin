package com.orwa.gatherin.Authentication.LoginUser.View;
...
import com.orwa.gatherin.Authentication.RegisterStudent.View.RegisterStudentActivity;
...
import com.orwa.gatherin.databinding.ActivityLoginUserBinding;
...
public class LoginUserActivity extends ParentClass {
...
//                Log.e("email", binding.etEmail.getText().toString());
                ...
                Observable observable = RetroWeb.getClient().create(AppServices.class).studentSignIn( binding.etEmail.getText().toString(), binding.etPassword.getText().toString())
                ...
                Observer<UserModel> observer = new Observer<UserModel>() {
                    ...
                    public void onNext(UserModel userModel) {
                        ...
                        if (userModel != null) {
                            if (userModel.isStatus()) {
                                ParentClass.sharedPrefManager.setLoginType("student");
                                sharedPrefManager.setUserDate(userModel.getData());
                                ParentClass.sharedPrefManager.setAccessToken(userModel.getAccessToken());
                                ParentClass.sharedPrefManager.setPassword(binding.etPassword.getText().toString());
                                ...
                                Bungee.split(LoginUserActivity.this);
                                successToast(LoginUserActivity.this, userModel.getMessage());


                            } else {
                                errorToast(LoginUserActivity.this, userModel.getMessage());
                            }
                        } else {
                            errorToast(LoginUserActivity.this, getString(R.string.somethingWentWrong));
                        }
                    ...
                    public void onError(Throwable e) {
                        handleApiException(LoginUserActivity.this, e);
//                        Log.e("e", e.toString());
                        stopLoading();
                    }
        ...
        binding.tvCreateNewSection.setOnClickListener(v -> {
            Intent intent = new Intent(LoginUserActivity.this, RegisterStudentActivity.class);
            startActivity(intent);
            Bungee.split(LoginUserActivity.this);
        });
    }
