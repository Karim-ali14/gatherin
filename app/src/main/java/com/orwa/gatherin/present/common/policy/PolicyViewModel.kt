package com.orwa.gatherin.present.common.policy
...
@HiltViewModel
class PolicyViewModel @Inject constructor(private val rep: ProfileRep) : BaseNetworkViewModel() {

    private val TAG=PolicyViewModel::class.java.simpleName
